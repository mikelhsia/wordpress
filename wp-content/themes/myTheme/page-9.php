            ...
            <div class="wrapper">
                <div class="content">
                	<?php
                		if(have_posts()) {
                			while (have_posts()) {
                				the_post(); // 重要：拿到该post的指标
                	?>
                			<h1 style="color: green; font-weight: bolder;"><?php the_title(); ?> </h1>
                			<p style="color:grey;text-align: right; font-style: italic; padding-left:30px;"> - <?php the_author( ); ?></p>
                	<?php
                				echo "<br/>";
                                echo "<p style='color:purple;text-align: middle; font-style: italic;'>3 times content on page id 9: </p><br/>";
                				the_content();
                                the_content();
                                the_content();
                			}
